        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['nama'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['kepsek'] == "" || $_REQUEST['nip'] == "" || $_REQUEST['website'] == "" || $_REQUEST['email'] == ""){
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',alamat='$alamat',kepsek='$kepsek',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="kepsek" type="text" class="validate" name="kepsek" value="<?php echo $row['kepsek']; ?>" required>
                                            ...
                                            ?>
                                        <label for="kepsek">Nama Kepala Instansi</label>
                                    </div>
                                    <div class="input-field col s6">
